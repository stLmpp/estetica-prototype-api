...
export const CreateAnamnesisFieldSchema = z
  .object({
...
export class CreateAnamnesisFieldDto extends createZodDto(
  CreateAnamnesisFieldSchema,
  { type: 'output' },
) {}

export const CreateAnamnesisFieldRequestSchema = z.object({
  anamnesisField: CreateAnamnesisFieldSchema,
});

export class CreateAnamnesisFieldRequest extends createZodDto(
  CreateAnamnesisFieldRequestSchema,
  { type: 'output' },
) {}
